 ...
 * @since 1.0.0
 */
class Elementor_Binance_Royal extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Binance Button', 'elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => esc_html__( 'Binance', 'elementor' ),
			]
		);
	...
	protected function render() {
        ...
        if(!empty($username)){
            ...
            $sql =  "SELECT meta_value FROM wp_usermeta WHERE meta_key = 'binance_url' AND user_id =".$user->ID;
            $registros = $wpdb->get_results($sql);
            $settings['link']['url'] = $registros[0]->meta_value;
        }
