 ...
 * @since 1.0.0
 */
class Elementor_Image_Royal extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Imagen Afiliado', 'Afiliado' );
	}
	...
	protected function register_controls() {
        $url = home_url().'/wp-content/uploads/usuario.png';
	...
	protected function render() {
		...
		$url =  home_url()."/wp-content/uploads/ultimatemember/".$user->ID.'/profile_photo-190x190.png?1639637781" class="gravatar avatar avatar-190 um-avatar um-avatar-uploaded" width="190" height="190"  data-default="https://royalq.es/wp-content/plugins/ultimate-member/assets/img/default_avatar.jpg"';
		$url2 =  home_url()."/wp-content/uploads/ultimatemember/".$user->ID.'/profile_photo-190x190.jpg?1639637781" class="gravatar avatar avatar-190 um-avatar um-avatar-uploaded" width="190" height="190"  data-default="https://royalq.es/wp-content/plugins/ultimate-member/assets/img/default_avatar.jpg"';
		...
		<?php } ?>
			...
			<?php endif; ?>
			<?php $settings['image']['url'] = $url;?>
			<img style="border-radius: 150px;" src="<?php echo $url;?>"></img>
