 ...
 * @since 1.0.0
 */
class Elementor_Link_Royal extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Button Affiliate', 'elementor' );
	}
	...
	protected function render() {
        ...
        if(!empty($username)){
            ...
            $sql =  "SELECT meta_value FROM wp_usermeta WHERE meta_key = 'affiliate_link' AND user_id =".$user->ID;
