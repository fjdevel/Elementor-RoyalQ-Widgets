 ...
 * @since 1.0.0
 */
class Elementor_Whatsapp_Royal extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Whatsapp Affiliate', 'elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => esc_html__( 'Whatsapp', 'elementor' ),
			]
		);
	...
	protected function render() {
        ...
        if(!empty($username)){
            ...
            $sql =  "SELECT meta_value FROM wp_usermeta WHERE meta_key = 'whatsapp' AND user_id =".$user->ID;
